...
% moderncv styles
%\moderncvstyle[green]{casual}       % optional argument are 'nocolor' (black & white cv) and 'roman' (for roman fonts, instead of sans serif fonts)
%\moderncvstyle[green]{classic}
...
\firstname{Iwein}
\familyname{Vranckx}
\title{lic. ir. ing.}               % optional, remove the line if not wanted
\address{Paul Delvaux wijk 26}{3000 Leuven, Belgi\"{e}}    % optional, remove the line if not wanted
\mobile{0498 57 76 04}                    % optional, remove the line if not wanted
\phone{+32 (0)16 43 83 29}                      % optional, remove the line if not wanted
%\fax{fax (optional)}                          % optional, remove the line if not wanted
\email{ivranckx@telenet.be}                      % optional, remove the line if not wanted
\extrainfo{ \weblink{http://users.telenet.be/$\sim$hosti}{}}
%\photo[64pt]{picture}                         % '64pt' is the height the picture must be resized to and 'picture' is the name of the picture file; optional, remove the line if not wanted
\quote{Any intelligent fool can make things bigger, more complex, and more violent. It takes a touch of genius -- and a lot of courage -- to move in the opposite direction.}                 % optional, remove the line if not wanted
...
\cvitem{Image processing}{Segmentatie, Medical Imaging, BeeldInterpretatie \& beeldanalyse, Artefact reductie op beelden}
%\cvitem{A.I}{Klassificatie mbv. Neurale netwerken, Support Vector Machines}
%\cvitem{Dsp}{Adaptieve filters, Adaptive noise cancellation,...}
\cvitem{IT.}{Ontwerp, optimalisatie en implementatie van Databasetoepassingen. C++ Qt application development, IT-projectmanagement, Mobile Wireless Internet.}
\cvitem{Industrie}{Productie-effici\"{e}ntie analyseren, IT-verbeteringsprojecten voorstellen en opvolgen. }

%Na een eerste introductie word je ingeschakeld op de dienst Factory Performance, en krijg je de verantwoordelijkheid over een aantal %verbeteringsprojecten binnen de productie-eenheid van Danone België.  Deze verbeteringsprojecten hebben tot doel om de productiekost te verlagen %en/of de productie-efficiëntie te verhogen.  Je hanteert hierbij methoden zoals Six Sigma en Lean Management en werkt nauw samen met collega’s %over de verschillende afdelingen.  Tevens geef je ondersteuning aan andere afdelingen in hun gebruik van methoden om zo de processen continu te %kunnen verbeteren. 
%Na een eerste ervaring binnen Danone België, verruim je je horizon en doe je een gelijkaardige ervaring op in een andere vestiging in het %buitenland gedurende een 6-tal maanden.   Na 2 à 3 jaar groei je door naar een leidinggevende functie binnen onze fabriek of één van onze andere %fabrieken binnen de Groep Danone.

%\cvlistem{Ontwerp, optimalisatie en implementatie van Databasetoepassingen}
%\cvlistitem{Digital Signal Processing: Adaptieve filters, Adaptive noise cancellation,...}
%Having an analytical mind, working goal oriented and being quality minded
...
\cvitem{Geboortedatum}{14 Oktober 1978, Merksem, Belgi\"{e}}
%\cvitem{Geboorteplaats}{Merksem, Belgi\"{e}}
\cvitem{Nationaliteit}{Belg}
\cvitem{Echtelijke staat}{Samenwonend, vader van Ilke en Arnout}
\cvitem{Hobby's}{Moutainbike, fitness, fietsvakanties, duurlopen, Linux \& Open source software.}        
...
\cvitem{Frans}{Spreken, lezen en schrijven}
%\cvitem{Duits}{Notities}
\cvitem{}{}
\closesection{}

%\section{\textsc{Algemene interesses}}
%\cvitem{Hobby's}{Moutainbike, fitness, fietsvakanties, duurlopen, Neurale netwerken, Linux \& Open source software.}        
...
%\cvitem{}{Lid van het Nederlandstalig Linux forum. Mijn roepnaam is \texttt{hosti} en mijn profiel kan hier gevonden worden: {\color{see} \weblink{http://forum.nedlinux.nl/profile.php?id=2463}}}
%\cvitem{}{Lid van het Nederlandstalig Ubuntu forum, geregistreerd als steunpunt in Leuven. Occasioneel los ik dus softwareproblemen van studenten op. {\color{see} \weblink{http://forum.ubuntu-nl.org}}}
%\closesection{}

%Your main tasks:
%- 	You will be involved in our projects of developing information systems for production management. You will be responsible for a specific project and a team of engineers.
%- 	You will set up the design of a product and participate in system analysis. Setting up and following up the planning and budget in SAP is also your responsibility.
%- 	Contacts and meeting with customers.
%- 	You will report to the Division leader.

%Your skills and qualities:     
%We are looking for a strongly motivated professional, meeting the following requirements:
%- Having an analytical mind, working goal oriented and being quality minded
%- Some years of intensive experience in software development
%- Operating Systems: Windows XP, Windows 2000, Windows 2003
%- Programming Environment: C#, .NET, Web Services, VC++, Java
%- Database: ORACLE, MS SQL Server
%- Methodology: UML, OO
%- A Master’s degree  in informatics, or equivalent
%- Excellent knowledge of English
%- As a leader you like to motivate people.
...
\cvitem{}{\textbf{Operating Systems}}
\cvitem{}{Alle Microsoft\begin{small}\texttrademark\end{small}\ operating systemen \& servers, Solaris\begin{small}\texttrademark\end{small},\ Unix, MacOS\begin{small}\texttrademark\end{small}, Linux}
\cvitem{}{}
\cvitem{}{\textbf{IT Technical knowledge}}
\cvitem{Algemeen}{LAN, WAN, WLAN, VoIP, VoIP QoS, Check point Firewall, VPN, Cisco routers, ITIL}
\cvitem{}{(Mathematical) Cryptography and data security, Open source Software, gcc,...}
\cvitem{}{}
\cvitem{}{\textbf{Programmeertalen / Programma's}}
%\cvitem{Procedural}{C, Perl, Pascal, QBasic}
\cvitem{Object-Oriented}{Qt4\begin{small}.5\end{small}, C\begin{small}++\end{small}, C\begin{small}\#\end{small}, UML}
...
\cvitem{Database}{MySQL \& SQL\begin{small}Lite\end{small} Servers, Oracle\texttrademark, MS Access\texttrademark}
...
%\cvitem{}{}
%\cvitem{}{\textbf{Office}}
\cvitem{Office}{\LaTeX, OpenOffice, Microsoft Office\begin{small}\texttrademark\end{small}, Lotus Notes}
\cvitem{Website/CMS}{Apache, Drupal, Joomla!, Wordpress, LifeRay}
\closesection{}
...
%\newline
%\cvitem{}{}
\cventry{\textbf{2005}}{Licenciaat in de biomedische beeldvorming optie Neuroimaging}{\newline Departement diergeneeskundige en biomedische wetenschappen}{Universiteit Antwerpen\htmladdnormallink{$^{*}$}{http://www.ua.ac.be/}}{}{}
%\cvitem{}{\textsc{Master Thesis}}
...
\cvitem{Omschrijving}{\small \textit{Tristan} is de naam van een tweejarig  automatisatieproject dat door mij en Patrick Mermans (Hansen Transmissions) opgestart werd. Allerhande productiegegevens - bijvoorbeeld: welke operaties zijn op een werkstuk uitgevoerd geweest - werden manueel ingeschreven in logboeken en de berekening en/of het opzoeken van verschillende procesparameters diende destijds nog met de hand te gebeuren. Dit overkoepelend ERP project had als doel het automatiseren van alle voorgenoemde handelingen. Tot op vandaag wordt dit programma gebruikt om de rendabiliteit, de productieflow en de productiegegevens van de hardingsafdeling bij te houden. Het programma omvat hiervoor verschillende middelgrote permissie gerelateerde ‘modules‘ voor kwaliteitscontrole, afwijkingsrapporten, orderplanning, orderverwerking, registratie van de perlietgegevens, berekening van het koolstofniveau in stukken en orderstatus (oa. acquisitie) modules. Dit programma is ontwikkeld geweest onder Visual Basic en C++/Qt, Windows.}
\cvitem{}{}
%\newline
...
\cvitem{}{}
\cvitem{}{Mijn ervaring situeert zich voornamelijk in software gerelateerd projectmanagement, technische analyse, IT consultancy, softwareimplementatie, procesautomatisatie en R\&D van geavanceerde wiskundige modellen. [...]}
\cvitem{}{}
\cvitem{}{}
\cvitem{}{}
\cventry{}{\textbf{Process Automation Engineer (IT)}}{}{}{}{}
\cvitem{}{Hansen Transmissions ({ \weblink{http://www.hansentransmissions.com}}) is \'{e}\'{e}n van de vijf grootste producenten van tandwielkasten voor windturbines en levert ook duurzame aandrijvingen voor een brede waaier aan industriele toepassingen overal ter wereld.}

\cvitem{2001-Sept. 2009 \begin{small}(Parttime)\end{small}}{Ik was verantwoordelijk voor het volledige beheer van automatisatieprojecten die mij werden toevertrouwd. Hierbij coordineerde ik alle aspecten - voorbereiding, implementatie, organisatie, uitvoering, oplevering en afsluiting - die hiermee samengingen. Deze automatisatie/verbeterings projecten hadden tot doel om de productiekost te verlagen en om de productie-efficientie te verhogen.}

\cvitem{}{}
%\cventry{}{Taken \& verantwoordelijkheden}{}{}{}{}
%\cvitem{}{De SVM classificatoren (Lineaire en kernelgebaseerde Support Vector Machines) die gebruikt worden in mijn thesis zouden van belang kunnen zijn voor de klassificatie van testopstellingen. Omdat SVMs een zeer hoge klassificatienauwkeurigheid hebben kan deze techniek perfect ingezet worden op foutenanalyse van lagers of het automatisch afkeuren van defecte tandwielkasten. Momenteel doe ik voorbereidend onderzoek naar de  haalbaarheid van deze techniek, de constraints die zij oplegt aan de ingangsdata en hoe we deze SV- Machines het beste kunnen trainen. Uiteindelijk zouden we deze kunstmatige intelligentie kunnen implementeren als software die - op basis van trillingsmetingen als ingangssignaal - automatisch aangeeft of een tandwielkast al dan niet voldoet aan de vereiste criteria.}
\cventry{}{Taken \& verantwoordelijkheden}{}{}{}{}

\cvitem{}{Analyseren van de automatisatiebehoeften en -problemen van leidinggevende ingenieurs en productieflow en het voorstellen van oplossingen.\newline 
\qquad o Onderzoek doen naar adequate (wiskundig of softwarematige) oplossingsmethoden. \newline
\qquad o Voorstellen van innoverende oplossingen en de bestaande processen in vraag stellen. \newline 
\qquad o Bepalen van de mogelijke impact van deze aanpassing op de coherentie van de productieflow. Ook het onderhandelen over de beste oplossingen voor de onderneming behoorde tot mijn takenpakket.\newline \newline 
Uitwerken en implementeren van de aanvaarde automatiseringsprojecten en deze opvolgen in samenwerking met de ingenieurs inzake kosten, tijdspanne en validatie testen. \newline 
      \qquad           o Voortdurend optreden als contactpunt tussen het project en de opdrachtgever. \newline 
      \qquad           o Voorstellen van de budgettaire noden van de projecten aan de verantwoordelijke en dit voorstel verdedigen om de middelen te verkrijgen.\newline 
      \qquad           o Onderhandelen, analyseren en uitwerken van prioriteiten. \newline 
      \qquad           o Dagdagelijks rapporteren aan de verantwoordelijke inzake de status van actieve projecten\newline \newline 
Uitdenken, opzetten en opvolgen van testprocedures.\newline \newline     
   Informeren en opleidingen geven aan ingenieurs en arbeiders. \newline 
      \qquad           o Regelmatig opleidingen geven inzake het gebruik van ontwikkelde software.\newline 
      \qquad           o Instaan voor de overdracht van de kennis en fungeren als aanspreekpunt voor problemen.\newline 
}

%-------------------------------------------------------------

\cventry{}{\textbf{Interim werk}}{leerkracht, arbeider}{}{}{}
\cvitem{}{}
\cvitem{Sept. 2009-Maart 2010 \begin{small}\end{small}}{Na mijn afstuderen als burgerlijk ingenieur (Sept. 2009) ben ik kort als leerkracht wiskunde tewerkgesteld geweest (Lipsius College, 2e en 3e graad, Overijse, 3 dagen per week). De rest van mijn tijd in deze periode gebruikte ik om als arbeider (Tyco Thermal controls, Haasrode) te werken.}
\cvitem{}{}

\cventry{}{\textbf{ICT-Adviseur Unizo}}{Consulent, Analist}{}{}{}
\cvitem{}{}
\cvitem{}{UNIZO - de Unie van Zelfstandige Ondernemers - verenigt ongeveer 85.000 ondernemers, zelfstandigen, KMO's en vrije beroepen in Vlaanderen en Brussel van eenmanszaak tot groei-KMO uit alle sectoren. Daarmee is het de grootste ondernemersorganisatie. UNIZO behartigt de ondernemersbelangen bij de overheid, in de media, bij de publieke opinie en bij de andere sociale partners. UNIZO geeft aan de leden advies, informatie en organiseert opleidingen en netwerking.}
\cvitem{}{}
\cvitem{April 2010-Okt. 2010 \begin{small}\end{small}}{Als IT adviseur sta ik in voor de software en hardwarematige ICT-advisering aan KMO's op basis van input van externe ICT-partners, eigen opzoekingwerk en eigen ervaringen. Ik initieer, begeleidt en breng ICT-veranderingstrajecten (ERP, CRM, CMS, ..) tot uitvoering bij KMO's en ruimer binnen een sector. Naast de bovengenoemde punten verzorg ik de dagelijkse communicatie en opvolging met de betrokken beroepssectoren  - evenals de organisatie van zowel praktisch als inhoudelijk opleidingen, workshops en netwerkevents.}

\cventry{}{Taken \& verantwoordelijkheden}{}{}{}{}
\cvitem{}{}
\cvitem{\textbf{Intern}}{Binnen UNIZO werkte ik als software en BI. analist. Ik was met andere woorden de persoon die het toepassingsdomein en technische eisen van nieuwe (CRM, project - en time management) software onderzocht, de implicaties (financieel, reikwijdte, impact, haalbaarheid voor bijscholing, integratie met ander software, hardware ... ) en de optimalisatie van bedrijfsbreedde informatiestromen voor zijn rekening nam. Occasioneel fungeerde ik als interne adviseur voor het IT-masterplan dat binnen afzienbare tijd geïmplementeerd zal worden.} 
\cvitem{}{}

\cvitem{\textbf{Extern}}{Het dagdagelijkse formuleren van antwoorden op adviesvragen van ondernemers, het op verplaatsing afnemen van audits bij KMO's, onafhankelijke trajectbegeleiding (opstellen van lastenboek, RFP en begeleiding v/d implementatie van ERP/CRM/CMS roll-out trajecten). Ook was het - in teamverband - integraal organiseren van conferenties voor KMO's omtrent verschillende onderwerpen (e-business, ERP, PPM, SaaS/Cloud computing) een belangrijke taak. Hiervoor werd samen gewerkt met verschillende partners en beroepssectoren waarmee frequent gecommuniceerd mee moest worden. \newline Merk tot slot op dat UNIZO een zeer sterk projectmatig gedreven organisatie is en als dusdanig een zéér goede leerschool vormt voor project management en de samenwerking met externe partners.} 

\cvitem{}{}
\cvitem{}{De voornaamste vereisten voor het uitvoeren van deze taken waren/zijn respectievelijk: \newline \newline 
%\cvitem{}{}
\qquad o Grondige kennis van desbetreffende softwaretechnologie (zowel HW als SW).\newline 
\qquad o Ervaring en expertise hebben met het programmeren, de ontwikkelling en het roll-out traject van computerprogramma's. \newline 
\qquad o Goede kennis hebben van bedrijfsprocessen en (optimalisatie van) bedrijfsbreede informatiestromen.  \newline 
\qquad o Gemakkelijk de voor-en nadelen van een nieuwe oplossing kunnen beredeneren.\newline 
\qquad o Overtuigingskracht hebben en vlot argumentatie kunnen aanhalen.\newline 
\qquad o Flexibel en adaptief zijn i/d besluitvorming.\newline 
\qquad o Zeer sterk communicatief zijn en voldoende empathie kunnen tonen.\newline 
}
...
\cventry{}{\textbf{Researcher}}{(Pattern recognition and image analysis) Researcher, R\&D Ingenieur}{}{}{}
\cvitem{}{}
\cvitem{}{\textit{BEST}, \textit{Belgian Electronic Sorting Technology}, (www.bestsorting.com) is een innovatief Belgisch bedrijf, gespecialiseerd in de ontwikkeling en productie van hoogtechnologische productiesorteermachines. BEST brengt een volledig gamma aan sorteertechnologieën op de markt. Het bedrijf maakt gebruik van camera, laser, LED en röntgen of een combinatie van deze technologieën. BEST is gespecialiseerd in de verwijdering van vreemde voorwerpen, defecten of verkleuringen in de voedingsindustrie (groenten, fruit, aardappelen, noten, enz). Andere toepassingsgebieden zijn tabak en recyclage. 95\% van de klantenportefeuille is internationaal. Sinds de oprichting in 1996 is BEST uitgegroeid tot de marktleider dankzij hun focus op innovatie, technische kwaliteit en de ontwikkeling van haar menselijk potentieel. Momenteel werken zo’n 200 medewerkers vanuit vestigingen in Haasrode, Eindhoven, Denver en Hongkong.}
\cvitem{}{}
\cvitem{Okt 2010-Heden \begin{small}\end{small}}{[...]}
\cvitem{}{}
\cventry{}{Taken \& verantwoordelijkheden}{}{}{}{}
\cvitem{}{}
\cvitem{}{[...]} 
...
\section{\textsc{Referenties}}
%\cvitem{\textbf{Operating Systems}}{}
\cvitem{}{Relevante referenties zijn probleemloos verkrijgbaar op aanvraag.}

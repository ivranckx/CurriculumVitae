...
\moderncvstyle{casual}       % idem classic casual
...
\cvitem{Parents}{Jos Vranckx, journalist, Greet Wouters, teacher.}
\cvitem{Date of Birth}{Oktober 14, 1978}
\cvitem{Place of Birth}{Merksem, Belgie}
\cvitem{Nationality}{Belgian}
\cvitem{Marital status}{Single}
%\cvitem{KULeuven ID}{\texttt{s0181755}}
%\vspace*{-1cm}
\section{\textsc{Languages}}
\cvitem{Dutch}{Mother tongue}
\cvitem{English}{Very Fluent speaking, reading and writing}
\cvitem{French}{Good speaking, reading and writing}
\cvitem{German}{Notes}
...
% Other Activities.
%
\section{\textsc{General Interest}}
\cvitem{Hobbies}{Mountain biking, fitness, cycling, long distance running, Linux, reading.}        
...
%\cvitem{}{}
\cventry{\textbf{2009}}{Master of Engineering: Civil Electrotechnical Engineer}{\newline Department of Engineering, ESAT}{Catholic University Leuven}{Belgium \htmladdnormallink{ $^{*}$}{http://www.kuleuven.be/}}{}
%\cvitem{}{\textsc{Master Thesis}}
\cvitem{Thesis}{\emph{Development of a parameter free, noise resistant OCR for Latin-Greek manuscripts.}}
...
\newline
%\cvitem{}{}
\cventry{\textbf{2005}}{Master of Science: Master in biomedical imaging, option Neuroimaging}{\newline Department of Veterinary and Biomedical Sciences}{University Antwerp}{Belgium \htmladdnormallink{ $^{*}$}{http://www.ua.ac.be/}}{}
%\cvitem{}{\textsc{Master Thesis}}
\cvitem{Thesis}{\emph{Reduction of ring artifacts on $\mu-CT$ images}}
...
%\cvitem{}{}
\newline
\cventry{\textbf{2004}}{Master in Engineering: Industrial Engineer Electronics}{\newline Department of Engineering}{Karel de Grote high school}{Antwerp, Belgium \htmladdnormallink{ $^{*}$}{http://www.kdg.be/}}{}
%\cvitem{}{\textsc{Master Thesis}}
...
%\cvitem{}{}
\newline
\cventry{\textbf{2001}}{Professional bachelor electromechanics}{\newline Department of Engineering}{Karel de Grote high school}{Antwerp, Belgium \htmladdnormallink{ $^{*}$}{http://www.kdg.be/}.}{}
%\cvitem{}{\textsc{Bachelor Thesis}}
\cvitem{Thesis}{\emph{Development of a database application for the registration of process data}}
...
The R\&D departement of Hansen would use this technique for bearing error analysis: if it is known what kind of errors can occur, Support Vectors could automatic classify faulty gearboxes. 
...
\cvitem{2006-2008}{During studies at the KULeuven mine as I stood - as an automation engineer for the improve the reporting for different types of production data. }
\cvitem{2005-2006}{Despite the large amount of work that accompanied mine biomedical thesis I was recalled in order to develop a program that could measure the impact of heat deformation on gear box axes.
This was specifically down to solving a problem by using frequency analysis using DSP techniques.
Until mine core in this period included the development and debugging Until mine core in this period included the development and debugging
mine of previously written software. {\color{see} \weblink{http://www.hansentransmissions.com}}}

\cvitem{2001-2004}{	
During this period I Hansen Transmissions in the project met Tristan. \\ The main work was designing a road map for development, just check and inquire what were the pain points, mathematical formulas to draw the necessary calculations, compilation of database layout \& queries, software implementation and finally to the verification and debugging of the results. All this was more than two years full-time work.
}

...
\cvitem{}{
Tijdens het maken van mijn thesis in het laatste jaar van mijn licenciaat studie is mijn interesse ontstaan voor wetenschappelijk onderzoek. Dit kwam meer dan van pas wanneer ik begon te werken als verpleegkundige 
op de dienst reumatologie en endocrinologie. Om zo snel mogelijk in te werken in de toch wel moeilijke problematiek van reumatolgie en minder mate
endocrinlogie waren mijn vaardigheden om snel de juiste informatie op te zoeken vereist.
Momenteel maak ik op de dienst ook deel uit van de werkgroep reuma, waar we bezig zijn met het maken van nieuwe pati\"{e}ntenfolders over het gebruik van medicatie en een nieuw type dossier.}
...
\cvitem{Vakantie}{Hier geldt als vuistregel: (bepakte) fietsvakanties en trekvakanties.}
%Het doel van Joker is tijdens de reis de plaatselijke bevolking zoveel mogelijk te ondersteunen. De reisgenoten zijn voor de reis onbekende, maar na de 
%reis zijn het vrienden geworden, dus sociale vaardigheden zijn hierbij belangrijk. 
\cvitem{}{In het verleden ben ik al op fietsvakantie in Frankrijk en Schotland geweest. Ook ben ik met de reisorganisatie Joker gaan rondtrekken in Egypte en Marokko.
In het verleden heb ik ook een inleefreis ondernomen naar Nicaragua. Tijdens deze reis is mijn intresse ontstaan in ontwikkelingssamenwerking.
}
\cvitem{Sport}{Indien ik de tijd vind probeer ik deze te benutten door te gaan fietsen, om zo mijn conditie op peil te houden.}
\cvitem {Andere intresses}{Tijdens mijn resterende vrije tijd probeer ik samen met vrienden zoveel mogelijke culturele activiteiten mee te pikken, zoals, cinema, concerten, toneel.}
...
\cvitem{2009 (sep)-heden}{Werkzaam bij het Rode Kruis in het bloedtransfusiecentrum.}
\cvitem{2007-2009}{Werkzaam op de afdeling reumatolgie en endocrinologie.}
\cvitem{2007-2007}{Kort werkzaam geweest op materniteit 441}
\cvitem{2006-2007}{Beginnnen werken in UZ Gasthuisberg op afdeling reumatologie en endocrinolgie}

\cventry{\textbf{2001-2005}}{Preprofessionele ervaring}{}{}{}{}
%\cventry {2001-2005} {Preprofessionele ervaring}{}{}

\cvitem{2004-2005}{Tijdens vakantieperiode met de CM als monitrice meegeweest voor de leeftijdsgroep 0-3 jarige.}

%\begin{itemize}
\cvitem{2003-2004}{Stages:}
\cvlistitem {4 weken NIC St. Augustinus Wilrijk}
\cvlistitem {4 verloskamer A.Z.H. Familie Reet}
\cvlistitem {5 weken verloskamer H. Hartziekenhuis Lier}
\cvlistitem {3 weken Kind en Gezin}
\cvlistitem {Vakantiewerk op de dienst Geriatrie  in H. Hartziekenhuis Mol.}
%\end{itemize}

\cvitem{2002-2003}{Stages:}
\cvlistitem {2 weken gynaecologie Imeldaziekenhuis Bonheide}
\cvlistitem {6 weken verloskamer A.Z. St. Dimpna}
\cvlistitem {4 weken materniteit H. Hartziekenhuis Lier}
\cvlistitem {1 week consultatie A.Z. Middelheim}
\cvlistitem {1 week bloedname A.Z. Middelheim}
\cvlistitem {1 week fertiliteit A.Z. Middelheim}
\cvlistitem {Vakantiewerk op de dienst Geriatrie  in H. Hartziekenhuis Mol.}

\cvitem{2001-2002}{Stages:}
\cvlistitem {4 weken materniteit A.Z. St. Dimpna}
\cvlistitem {3 weken heelkunde (urologie) A.Z. St. Dimpna}
\closesection{}

\section{\textsc{Computervaardigheden}}
\cvitem{OS}{Alle Microsoft\texttrademark\ operating systemen, Ubuntu Linux}
\cvitem{Office}{Lyx, Microsoft Office\texttrademark, OpenOffice}

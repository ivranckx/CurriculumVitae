...
\name{Tinne}{Wouters}
\address{Oudenbos 81, 3202 Rillaar}
\mobile{(+32)+0494 13 45 22}
...
%\position{Docent} % {\enskip\cdotp\enskip}Security Expert Your expertise/fields
...
\recipient{KDG-hogeschool}{Campus Zuid	\\Brusselstraat 45\\ 2018 Antwerpen} % The company being applied to

\letterdate{23 September, 2018} % The date on the letter, default is the date of compilation

\lettertitle{Betreft: sollicitatie voor lector Verpleegkunde.} % The title of the letter

\letteropening{\\Geachte Mevrouw Cleerbout, \\ Beste Ann, } % How the letter is opened
...
\makecvfooter{23 September, 2018}{Tinne Wouters~~~·~~~Begeleidend schrijven}{} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
